...
public:  
    HttpRequestBuilder(){
        cout << "HttpRequestBuilder constructor" << endl;
    }
    // Method chaining
...
int main() {
    ...
    cout << &builder << endl;
    HttpRequestBuilder builder2 = builder.withUrl("https://localhost");
    cout << &builder2 << endl;
    // cout << &(builder->withUrl("https://localhost")) << endl;
    builder2.withBody("THIS is Body");
    builder.withBody("THIS is request 1 Body");
    HttpRequest request = builder.build();
    request.execute();
    // builder.withTimeout(40);
